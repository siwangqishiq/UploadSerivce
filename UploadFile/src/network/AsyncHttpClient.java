 ...
 * </pre>
 * 
 * @see com.suning.babeshow.net.loopj.android.http.AsyncHttpResponseHandler
 * @see com.suning.babeshow.net.loopj.android.http.ResponseHandlerInterface
 * @see com.suning.babeshow.net.loopj.android.http.RequestParams
 */
public class AsyncHttpClient {
	...
	public static final int DEFAULT_SOCKET_TIMEOUT = 20 * 1000;// 请求超时时间
	 ...
	 * @see com.suning.babeshow.net.loopj.android.http.MyRedirectHandler
	 */
